	...
	return knex('users').del()
		.then(function () {
			return knex('users').insert([{
				...
				facebook: 'https://facebook.com/tedo_thynia',
				instagram: 'https://instagram.com/tedo_coolmom'
			}, {
				name: 'Barb',
				...
				facebook: 'https://facebook.com/barbkellner',
				instagram: 'https://instagram.com/dapizzaeater'
			}, {
				name: 'Jimbo',
				...
				facebook: 'https://facebook.com/jimbocooldad',
				instagram: 'https://instagram.com/jimbo_cooldad'
			}]);
		});
};
